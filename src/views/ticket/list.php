        ...
        <div class="col-sm-10 p-4">
            ...
            <div class="nav-item dropdown dropleft float-right">
                ...
                <div class="dropdown-menu shadow-sm border-0" style="text-align: center">
                    ...
                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#bulk-delete-modal"
                       tabindex="-1">
                        <?= Yii::t('super', 'Delete') ?>
                    </a>
                </div>
...
<?php \yii\bootstrap4\Modal::begin(['id' => 'bulk-delete-modal', 'title' => Yii::t('super', 'Bulk Delete')]); ?>
<?= $this->render('parts/modal_bulk_delete'); ?>
<?php \yii\bootstrap4\Modal::end(); ?>