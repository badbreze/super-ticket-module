...
?>
<div class="giiant-crud super-ticket-sla-index">
    ...
    <h1>
        <?= Yii::t('models.plural', 'Super Ticket Sla') ?>
        <small>
            <?= Yii::t('app', 'List') ?>
        </small>
    </h1>
        ...
        <?= GridView::widget([
                                 ...
                                 'columns' => [
                                     ...
                                     [
                                         ...
                                         'attribute' => 'scheduling_id',
                                         'value' => function ($model) {
                                             if ($rel = $model->scheduling_id) {
                                                 return Html::a(
                                                     $rel->name,
                                                     ['super-scheduling/view', 'id' => $rel->id,],
                                                     ['data-pjax' => 0]
                                                 );
                                             } else {
                                                 return '';
